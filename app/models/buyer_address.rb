class BuyerAddress
  ...
  with_options presence: true do
    ...
    validates :phone_number,
              format: { with: /\A[0-9]{10,11}\z/, message: 'is not include hyphens (-) only 10 or 11 digit numbers' }
    validates :item_id
    validates :user_id
    validates :token
  end
  ...
  def save
    ...
    Address.create(postal_code: postal_code, area_id: area_id, city: city, house_number: house_number, house_name: house_name,
